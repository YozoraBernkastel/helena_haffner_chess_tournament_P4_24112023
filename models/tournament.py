...
class Tournament:
    ...
    def no_repeat_game(self, actual_player, round_players: list) -> list:
        ...
        for opponent in round_players:
            ...
            if len(self.rounds_list) < len(round_players) - 1:
                ...
                # peut encore boucler à l'infinie s'il ne reste qu'un lonely possible et qu'à cause de l'attribution
                ...
                # la liste en deux et mettre le bout de liste avec le joueur tiré au sort en début de liste lorsqu'on refusionne les deux ????
